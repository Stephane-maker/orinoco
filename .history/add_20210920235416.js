if (document.readyState) {
    ...
    clickUserVoirMoins("buttonourson", "containerArticle", "oursonButton");
    clickUserVoirMoins("buttoncamera", "containerArticle", "cameraButton");
    clickUserVoirMoins("buttontable", "containerArticle", "tableButton");
}