...
function MakkeDiv(elementRequete, valeurMin) {
    ...
    newButton.addEventListener("click", function() {
        ...
        if (y == "first-click") {
            ...
            console.log(elementRequete)
        } else if (y == "second-click") {
            console.log("second click");
            newButton.setAttribute("data-click", "first-click")

            switch ("second-click") {
                case elementRequete == "teddies":
                    console.log("teddies");
                    for (let i = 0; i < 3; i++) {
                        let focus = document.getElementById("generalContainer");
                        focus.remove();
                    }
                    break;
                case elementRequete == "cameras":
                    console.log("cameras")
                    for (let i = 0; i < 3; i++) {
                        let focus = document.getElementById("generalContainer");
                        focus.remove();
