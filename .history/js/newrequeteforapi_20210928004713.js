...
function MakkeDiv(elementRequete, divProduits, chiffre) {
    ...
    requete(elementRequete, divProduits, chiffre);
    ...
    newButton.addEventListener("click", function() {
        ...
        if (y == "first-click") {
            ...
            requete(elementRequete, divProduits, chiffre);
            chiffre = 5;
            return (requete(elementRequete, divProduits, chiffre))
...
function requete(elementRequete, divProduits, chiffre) {
