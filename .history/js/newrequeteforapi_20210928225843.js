...
function makkeNavBar() {
    ...
    createLinkTitleForNavBar.getAttribut("href", "#");
    ...
    createLinForLi.getAttribut("href", "#");
    ...
    createInputForSearch.getAttribut("type", "search")
    ...
    createButtonForSearch.getAttribut("type", "submit");
