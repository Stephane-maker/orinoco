...
function makkeNavBar() {
    ...
    createLinkTitleForNavBar.getAttribute("href", "#");
    ...
    createButtonBootstrapForResponsive.getAttribute("data-bs-toggle", "collapse");
    createButtonBootstrapForResponsive.getAttribute("data-bs-target", "#navbarTogglerDemo02");
    createButtonBootstrapForResponsive.getAttribute("aria-controls", "navbarTogglerDemo02");
    createButtonBootstrapForResponsive.getAttribute("aria-expanded", false);
    createButtonBootstrapForResponsive.getAttribute("aria-label", "Toggle navigation")
    ...
    createLinForLi.getAttribute("href", "#");
    ...
    createInputForSearch.getAttribute("type", "search")
    ...
    createButtonForSearch.getAttribute("type", "submit");
