class GeneralClassAccesoire {
    ...
    addLinkForGeneralClassAccesoire(divProduits) {
        ...
        eltGeneral = MakkeDiv(elementRequete)
    }
    addLensesCamera() {
...
function MakkeDiv(elementRequete) {
    ...
    creationTextDescriptionProduitCardBody.textContent = "description";
    ...
    creationClassPrixProduitCardBody.textContent = "Price";
    ...
    creationDetailProduitCardBody.textContent = "";
