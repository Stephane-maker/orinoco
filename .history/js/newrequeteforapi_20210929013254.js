...
function MakkeDiv(elementRequete) {
    ...
    const importegeneralClassConstructor = new GeneralClassAccesoire();
    //creation de l'image du produit
    let imageProduit = document.createElement("img");
    imageProduit.setAttribute("src", importegeneralClassConstructor(this.imageUrl))
    ...
    creationTitleCardBody.textContent = importegeneralClassConstructor(this.name);
