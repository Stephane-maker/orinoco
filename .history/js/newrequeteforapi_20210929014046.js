class GeneralClassAccesoire {
    ...
    addLinkForGeneralClassAccesoire(divProduits, creationDetailProduitCardBody) {
        let eltGeneral = divProduits
        let eltGeneral1 = creationDetailProduitCardBody;
        let detail = "";
        eltGeneral.innerHTML = this.name + this.price;
        creationDetailProduitCardBody.innerHTML = this.lenses
