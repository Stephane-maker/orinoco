class GeneralClassAccesoire {
    ...
    addLinkForGeneralClassAccesoire(divProduits) {
        ...
        let creationBouttonCard = document.createElement("a");
        creationBouttonCard.setAttribute("href", "#");
        ...
        creationBouttonCard.setAttribute("data-click", "first-click")

        creationBouttonCard.addEventListener("click", function() {
            let b = creationBouttonCard.getAttribute("first-click");

            if (b == "first-click") {
                console.log("pret pour la requete")
            }
