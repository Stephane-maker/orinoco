...
function clickUser(idbtn, idUrl, classMereBtn) {
    ...
    focusButton.addEventListener('click', function() {
        ...
        console.log(idbtn + voirMoins)
    })
}

// function pour supprime les articles au click de l'utilisateur function clickUserVoirMoins() {
let anotherFocusBtn = document.getElementById("buttonoursonMoins");
