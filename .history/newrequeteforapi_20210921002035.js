...
class GeneralClassAccesoire {
    ...
    addLinkForGeneralClassAccesoire(IdAccesoire) {
        ...
        eltGeneral.innerHTML = eltGeneral.innerHTML + "<div id =\"containerArticle\"" + this.type + " class=\"card\" style=\"width: 30rem;\">" +
...
function clickUserVoirMoins() {
    for (let i = 0; i < 3; i++) {
        ...
        let focus = document.getElementById("containerArticle");
        focus.remove();
    }
}