...
function clickUser(idBtn, idUrl, idArticle, classMereBtn) {
    ...
    focusButton.addEventListener('click', function() {
        ...
        afterDelet.id = "buttonoursonVoirMoins";
...
function clickUserVoirMoins() {
    let anotherFocusBtn = document.getElementById("buttonoursonVoirMoins");

    anotherFocusBtn.addEventListener("click", function() {
        for (let i = 0; i < 3; i++) {

            let d = document.getElementById("generalContainerourson");
