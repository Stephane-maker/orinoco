...
function clickUserVoirMoins(idMoins, article) {
...
function atclick() {
    clickUserVoirMoins("buttonoursonVoirMoins", "containerArticle")
    clickUserVoirMoins("buttoncameraVoirMoins", "containerArticle")
    clickUserVoirMoins("buttontableVoirMoins", "containerArticle")
}