...
function atclick() {
    clickUserVoirMoins("buttonoursonVoirMoins", "containerArticle", "oursonButton")
    clickUserVoirMoins("buttoncameraVoirMoins", "containerArticle", "cameraButton")
    clickUserVoirMoins("buttontableVoirMoins", "containerArticle", "tableButton")
}