...
function test() {
    ...
    i.addEventListener("click", function() {
        console.log("ok")
        i.setAttribute("onclick", "test2()")
        i.id = "s"
    })
}

function test2() {
    let z = document.getElementById("buttonourson");
...
function f() {
    let p1 = document.getElementById("generalContainerourson");

    let enfant = p1.childNodes;
    console.log(enfant[1])
}