...
function MakkeDiv(elementRequete, valeurMin) {
    ...
    newButton.addEventListener("click", function() {
        ...
        if (y == "first-click") {
            requete(elementRequete, divProduits, valeurMin)
            valeurMin = valeurMax;
            console.log(valeurMin)
            newButton.setAttribute("data-click", "second-click")
            return requete(elementRequete, divProduits, valeurMin)
        } else if (y == "second-click") {
            divProduits.children = remove()

        }
    })
    divForButton.appendChild(newButton);
    console.log(divProduits.children)
    return newDiv;
}
