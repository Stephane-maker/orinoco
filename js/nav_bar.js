function makkeNavBar(prix) {
    ...
    if (document.location.href.includes("index.html")) {
        createLinForLi.style.display = "none";
    }
    ...
    //creation de l'evenement aller au panier
    createLinkForPanier.addEventListener("click", function() {
        document.location.href = "panier.html";
    })

    //condition pour affiche des element de la navBar
    if (document.location.href.includes("panier.html")) {
        createLinkForPanier.style.display = "none";
    }
